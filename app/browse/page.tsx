...
export default function BrowsePage() {
  ...
  const [discoverSites, setDiscoverSites] = useState<WhitelistSite[]>([]);
  ...
  useEffect(() => {
    ...
    const shuffled = [...nonPopular].sort(() => Math.random() - 0.5);
    setDiscoverSites(shuffled.slice(0, 7));
  ...
  return (
    <div className="flex min-h-full flex-col bg-zinc-50/50 dark:bg-zinc-950">
      {/* Header */}
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1">
        ...
        <aside className="hidden lg:flex w-56 shrink-0 flex-col border-r border-zinc-200/80 bg-white/60 dark:border-zinc-800 dark:bg-zinc-900/40">
