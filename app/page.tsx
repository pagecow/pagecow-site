      ...
      <main className="flex w-full max-w-2xl flex-1 flex-col items-center justify-center gap-8 py-12 sm:gap-10 sm:py-20">
        ...
        <div className="flex flex-col items-center gap-4 pt-2 sm:pt-4">
          ...
          <div className="flex w-full flex-wrap justify-center gap-3">
            <a
              href="#"
              className="inline-flex min-w-[9rem] items-center justify-center gap-2 rounded-full border border-zinc-300 px-6 py-2.5 text-sm font-medium transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
            >
